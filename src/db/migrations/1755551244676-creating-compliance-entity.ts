...
export class CreatingComplianceEntity1755551244676 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.query(`
        ...
        COMMENT ON COLUMN "compliances"."scheduledAt" IS 'Scheduled date for compliance to be processed'
      `);
      ...
      await queryRunner.query(`
        ALTER TABLE "compliances" ADD CONSTRAINT "FK_f8dfd9af260fe98098d56e7252a"
          FOREIGN KEY ("account_id") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
      `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.query('ALTER TABLE "compliances" DROP CONSTRAINT "FK_f8dfd9af260fe98098d56e7252a"');
